...
public class DoublyLinkedList<E> extends AbstractList<E>
{
    ...
    public void splice(int index, DoublyLinkedList<E> other){
    	...
    	if(index == 0){
    		...
    		other.tail.setNext(after);
    		after.setPrevious(head);
    		count += other.count;
    	...
    	DoublyLinkedNode<E> after = before.next();
    	
    	before.setNext(other.head);
    	after.setPrevious(other.tail);
    	other.head.setPrevious(before);
    	other.tail.setNext(after);
